...
public class StringMethods {
    ...
    public static String compareEquality(String a, String b) {
        ...
        String equals = "equals: " + a.equals(b);
        String equalsIgnoreCase = "equalsIgnoreCase: " + a.equalsIgnoreCase(b);
        String s = equals + ", " + equalsIgnoreCase;
        return s;
    }
    ...
    public static String searchString(String text, String keyword) {
        ...
        return "Contains: " + contains + ", indexOf: " + index;
    }
    ...
    public static String replaceDemo(String text, String oldWord, String newWord) {
        ...
        String replace = text.replace(oldWord, newWord);
        String replacedAll = replace.replaceAll("\\d", "#");
    ...
    public static String checkStartEnd(String filename, String prefix, String extension) {
        ...
        String result = "StartsWith " + prefix + ": " + startsWith + ", " +
                        "EndsWith " + extension + ": " + endsWith;
        return result;
    }
    ...
    public static String formatReceipt(String item, int quantity, double price) {
        ...
        String formatted = String.format("%-15s x%-5d $%.2f", item, quantity, price);
        return formatted;
    }
