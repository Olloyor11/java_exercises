...
public class AccessDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(modifiers.publicGreeting());
        ...
        System.out.println(modifiers.packageGreeting());
        ...
        modifiers.setSecret("This is a Secret String!");
        System.out.println(modifiers.getSecret());
        ...
        /* modifiers.secret = "trying direct access to private field is not possible outside the class,
         only access to the private field or method is with getter and setter method!
          if it is within that class then it is possible to access to private method or field directly without getter and setter! "
        */
    }
}
